...
//        Bitmap bitmap = Bitmap.createBitmap(1000, 100, Bitmap.Config.ARGB_8888);
//        Canvas canvas = new Canvas(bitmap);
//        RectF rectF = new RectF(mMainLayout.getLeft(),mMainLayout.getTop(),mMainLayout.getRight(),mMainLayout.getBottom());
//        canvas.drawRoundRect(rectF,10f,10f,paint);
    ...
    public void setIsClickAble(boolean isClickAble){
        ...
        mMainLayout.setBackground(isClickAble ? getResources().getDrawable(R.drawable.white_shap) : getResources().getDrawable(R.drawable.gray_shap));
    }
    ...
    public void setRightImgClick(OnRightCheckClickListener onRightCheckClickListener){
        if(getRightDrawable() != null){
           mRightView.setOnClickListener(new OnClickListener() {
               @Override
               public void onClick(View view) {
                   Drawable drawable = getRightDrawable();
                   boolean isOn = drawable == getResources().getDrawable(R.drawable.ic_check_on);


                   if(onRightCheckClickListener != null)
                       onRightCheckClickListener.onRightImgClick(isOn);
               }
           });
        }
    }
    ...
    //设置点击的状态
    public void setRightDrawableStatus(boolean isCheck){
        Drawable drawable = getRightDrawable();
        boolean isOn = drawable == getResources().getDrawable(R.drawable.ic_check_on);
        Log.e("RIGHT","--isOn="+isOn+" "+isCheck);
//        if(isOn == isCheck)
//            return;
        setRightDrawable((isCheck && isOn) ? R.drawable.ic_check_off : ((!isCheck && !isOn) ? R.drawable.ic_check_on :  R.drawable.ic_check_off));
    }
    ...
    public interface OnRightCheckClickListener{
        void onRightImgClick(boolean isChecked);
    }
}